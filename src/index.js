...
const fs = require('fs')
const ImageSizeResolver = require('./modules/imageSizeResolver')
const resolveScaledImages = require('./modules/scaledImageResolver')
const { readFileAsync } = require('./modules/asyncFs')
const { createImageWrapper } = require('./modules/imageWrapper')
